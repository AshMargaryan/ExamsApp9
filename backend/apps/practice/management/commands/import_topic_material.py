...
from apps.practice.models import Subject, Domain, Topic
...
class Command(BaseCommand):
    help = (
        "Import topic intro text from output/generated/material/topics/topNN.md "
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f"Done. {imported} topic(s) updated."))
        if missing:
